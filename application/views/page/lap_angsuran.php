              ...
              <tbody>
                ...
                foreach ($langsuran as $row) { ?>
                  <tr>
                    ...
                    <td>
                      <?php
                      $bulan = explode('-', date('Y-m-d', strtotime($row->angsuran_waktu)));
                      if ($bulan[2] > 10) : ?>
                        <span class="badge badge-danger">Pembayaran Terlambat</span>
                        <?php else : ?>
                      ...
                      <td>
                        <a href='<?=base_url("bukti_angsuran/$row->angsuran_id")?>' target="_blank" class="btn btn-info btn-sm"><span class="fa fa-print"></span></a>
                      </td>
                    </tr>
                  <?php } ?>
                </tbody>
