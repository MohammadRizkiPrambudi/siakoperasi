        ...
        <div class="card">
          <div class="card-body">
            ...
            <hr>
              ...
              <b>Total Penagihan :</b> Rp. <?=number_format($data->pinjaman_total)?><br>
              <b>Kekurangan : </b> <?= $data->pinjaman_tempo - $pinjaman->total; ?> Bulan <br>
              <b>Jumlah Pelunasan : </b>Rp. <?= number_format($data->pinjaman_total - $pinjaman->total_bayar); ?>  
